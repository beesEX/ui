  ...
  componentDidMount() {
    ...
    ws.onmessage = (event) => {
      ...
      if(parsedData.type === 'ORDER_BOOK_EVENT') {
        ...
        if(filledCompletely) this.removeVolumeByPrice(_side, index); // [Tung]: filledCompletely=true means, the the volumes at
                                                                     // that price level should be decreased by
                                                                     // quantity, but does not mean, that the volumes
                                                                     // at that price level should be removed
