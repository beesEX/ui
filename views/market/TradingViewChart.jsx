...
export class TradingViewChart extends React.PureComponent {
  ...
  componentDidMount() {
    ...
    const widgetOptions = {
      ...
      datafeed: new BeesExDataFeed(this.props.webSocketToServer),
    ...
    tvWidget.onChartReady(() => {
      const button = tvWidget.createButton().attr('title', 'Click to show a notification popup')
        .addClass('apply-common-tooltip').on('click', () => tvWidget.showNoticeDialog({
          title: 'Notification',
